...
- [gpartin/CryptoGuard](https://github.com/gpartin/CryptoGuard) 🐍 ☁️ - Deterministic crypto risk scanner powered by physics-based anomaly detection. Detected every major crypto crash in backtesting — 27 days early on average, 5× fewer false alarms than statistical baselines. PROCEED/CAUTION/BLOCK verdicts for any token via 5 MCP tools. $0.05/scan via x402 USDC on Base.
